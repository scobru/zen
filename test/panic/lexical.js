      ...
      function (test) {
        ...
        var t2 = setTimeout(function () {
          ...
          if (results_unique.length === len) {
            ...
            console.log(
              "RESULTS Query server - Between(< item <): ",
              results_unique.length,
              results_unique.join(", "),
            );
      ...
      function (test) {
        ...
        var t2 = setTimeout(function () {
          ...
          if (results_unique.length === len) {
            ...
            console.log(
              "RESULTS Query server - Exact match(=): ",
              results_unique.length,
              results_unique.join(", "),
            );
            test.fail(
      ...
      function (test) {
        ...
        var t2 = setTimeout(function () {
          ...
          if (results_unique.length === len) {
            ...
            console.log(
              "RESULTS Query server - Prefix match(*): ",
              results_unique.length,
              results_unique,
            );
            test.fail(
          ...
          function (test) {
            ...
            var t2 = setTimeout(function () {
              ...
              if (results_unique.length === len) {
                ...
                console.log(
                  "RESULTS Query browser - Between(< item <): ",
                  results_unique.length,
                  results_unique.join(", "),
                );
                test.fail(
          ...
          function (test) {
            ...
            var t2 = setTimeout(function () {
              ...
              if (results_unique.length === len) {
                ...
                console.log(
                  "RESULTS Query browser - Exact match(=): ",
                  results_unique.length,
                  results_unique.join(", "),
                );
                test.fail(
          ...
          function (test) {
            ...
            var t2 = setTimeout(function () {
              ...
              if (results_unique.length === len) {
                ...
                console.log(
                  "RESULTS Query browser - Prefix match(*): ",
                  results_unique.length,
                  results_unique,
                );
                test.fail(
