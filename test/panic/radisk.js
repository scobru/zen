    ...
    return alice.run(
      function (test) {
        ...
        var n = Zen.time.is(),
          ...
          b = env.config.burst,
          l = env.config.each;
        var raw = Zen.text.random(200, "a"); // ""
        ...
        function save(i) {
          ...
          var d;
          var ref = window.zen.get("asdf" + i);
          ref.put({ hello: raw + i }, function (ack) {
            if (ack.err) {
              if (ack.lack) {
                console.log("!!!???", i);
                return test.fail(
                  "ACK timed out, turn your lack of ack up or thruput down.",
                );
              }
            ...
            d = true;
            c++;
            !(i % (b * 4)) && console.log(i + "/" + l); //, '@'+Math.floor(b/((-n + (n = Zen.time.is()))/1000))+'/sec');
            //localStorage.clear();
            ref.off();
            //console.log("gl:", Object.keys(window.zen._.graph).length);
            if (c < l) {
              return;
            }
