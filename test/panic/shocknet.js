	...
	it("Server Peer initialized gun!",function(){
		...
		peerClients.each(function(client, id){
			tests.push(client.run(function(test){
				var env = test.props;
				test.async();
				try{ __fs.unlinkSync((3+env.i)+'data') }catch(e){}
				try{ __fs.unlinkSync((env.i+1+3)+'data') }catch(e){}
				try{ __fsrm((3+env.i)+'data') }catch(e){}
				try{ __fsrm((env.i+1+3)+'data') }catch(e){}
	...
	it("Server Clients initialized gun!", function(){
		...
		serverClients.each(function(client, id){
			tests.push(client.run(function(test){
				...
				try{ __fs.unlinkSync((env.i+1)+'data') }catch(e){}
				try{ __fsrm(env.i+'data') }catch(e){}
				try{ __fsrm((env.i+1)+'data') }catch(e){}
				var Gun = __index;
