      ...
      tests.push(
        client.run(
          function (test) {
            ...
            load(
              "https://cdn.jsdelivr.net/gh/QVDev/GunStreamer/js/GunRecorder.js",
              function () {
                load(
                  "https://cdn.jsdelivr.net/gh/QVDev/GunStreamer/js/GunStreamer.js",
                  function () {
                    load(
                      "https://cdn.jsdelivr.net/gh/QVDev/GunStreamer/js/GunViewer.js",
                      function () {
                        load(
                          "https://cdn.jsdelivr.net/gh/QVDev/GunStreamer/js/mediabuffer.js",
                          function () {
                            test.done();
                          },
                        );
    ...
    return alice.run(
      function (test) {
        ...
        var record = (window.record = new GunRecorder({
          ...
          }, // pass recorded data to streamer
        }));
        record.startCamera();
