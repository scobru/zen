    ...
    var radix = function (key, val, t) {
      ...
      if (!at) {
        if (
          ...
          (at && "object" == typeof at ? at : (t[k] = { "": at }))[""] = val;
    ...
    try {
      ...
      for (; i < l; i++) {
        ...
        if (rev) {
          ...
          tmp = tree && "object" == typeof tree && rap(tree, cb, opt, p);
          if (u !== tmp) {
            return tmp;
          }
        }
        ...
        pre = p;
        if (!rev) {
          tmp = tree && "object" == typeof tree && rap(tree, cb, opt, pre);
          if (u !== tmp) {
            return tmp;
          }
        }
