if (!globalThis.$) {
  ...
  (($ = globalThis.$ =
    function (q, tag, I, u) {
      ...
      if ("string" != typeof q) {
        return ((I.tags = (q = q || []).tags || u === q.length ? [q] : q), I);
      }
      if ("<" === q[0]) {
        return I.add(q);
      }
      return (
        q.split(",").forEach(function (q) {
          I.add((tag || document).querySelectorAll(q));
        }),
        I
      );
    }).fn = $.prototype).each = function (cb) {
    return ($.each(this.tags, cb), this);
  };
  $.each = function (o, cb) {
  ...
  $.fn.add = function (add, tmp, u) {
    if (!add) {
      return this;
    }
    if ("<" === (tmp = add)[0]) {
      (add = document.createElement("div")).innerHTML = tmp;
      add = add.children[0];
    }
    add =
      "string" == typeof add
  ...
  $.fn.get = function (i, l, u) {
    return ((l = this.tags), i === u ? l : l[i]);
  };
  $.fn.is = function (q, b) {
    return (
  ...
  $.fn.place = function (where, on, f, op, I) {
    return (I = this).each(function (i, tag) {
      $(on).each(function (i, node) {
  ...
  $.fn.append = function (html) {
    return ($(html).place(0.1, this), this);
  };
  $.fn.appendTo = function (html) {
    return this.place(0.1, $(html));
  };
  function rev(o, I) {
    (I = $()).tags = [].slice.call(o.tags).reverse();
    return I;
  }
  $.fn.prependTo = function (html) {
    return (rev(this).place(-0.1, $(html)), this);
  };
  $.fn.prepend = function (html) {
    return (rev($(html)).place(-0.1, this), this);
  };
