// lib/build-crypto.js — Build script for crypto.wasm
// Mirrors the pattern from lib/build-pen.js.
//
// Compiles src/crypto_wasm.zig → src/crypto.wasm (and copies to root crypto.wasm).
...
const src = nodePath.join(rootDir, "src/crypto_wasm.zig");
