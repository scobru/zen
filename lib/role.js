	...
	*/
    ...
    chain =
      ...
      zen
        ...
        .get("c")
        .get("d")
        .get(function (a, b, c, tmp) {
          // a.zen._.soul || a.zen._.link;
          a.ID = a.ID || Zen.text.random(2);
          console.log("********", a.put || a); //, Zen.node.soul(a.put), a.zen._);//, a.zen.back(function back(_){_.get && (tmp || (tmp = [])).push(_.get);return _.back? undefined : tmp;}));
          //b.rid(a);
        });
    console.log("~~~~~~~~~~~~~~");
  }
...
*/
  ...
  /*
zen.get('x').get('y').get('z').put({xyz: 'zyx'});
*/
