...
"use strict";
{
  ...
  edide.logProd = function (edide, logProd) {
    return (...args) => {
      ...
      console =
        (ref = (ref1 = edide.editorModule) != null ? ref1.console : void 0) !=
        null
          ? ref
  ...
  edide.strParsesToNumber = function (edide, strParsesToNumber) {
    Object.defineProperty(this, "module_name", { value: "strParsesToNumber" });
  ...
  edide.mmParserSpecial = function (edide, mmParserSpecial) {
    Object.defineProperty(this, "module_name", { value: "mmParserSpecial" });
  ...
  edide.moduleGate = function (edide, moduleGate) {
    ...
    this.active; // module that is currently being edited (can be root or in globalThis)
