import __zen from "../zen.js";
{
  ...
  Zen.on("opt", function (root) {
    ...
    opt.rtc.room =
      opt.rtc.room ||
      (Zen.globalThis &&
        (location.hash.slice(1) || location.pathname.slice(1)));
      ...
      if ((tmp = rtc.offer)) {
        ...
        return peer.createAnswer(
          function (answer) {
            ...
            root.on("out", {
              "@": msg["#"],
              ok: { rtc: { answer: answer, id: opt.pid } },
            });
          },
          function () {},
          opt.rtc.sdp,
    ...
    function open(msg, rtc, peer) {
      if ((peer = opt.peers[rtc.id] || open[rtc.id])) {
        return peer;
      }
      ...
      peer.onicecandidate = function (e) {
        ...
        root.on("out", {
          "@": (msg || "")["#"],
          "#": root.ask(plan),
          ok: { rtc: { candidate: e.candidate, id: opt.pid } },
        });
      };
