...
(function(){
	...
	Zen.on('opt', function(root){
		...
		var env;
		if(typeof globalThis !== "undefined"){ env = globalThis }
    ...
    opt.rtc.room = opt.rtc.room || Zen.globalThis && (location.hash.slice(1) || location.pathname.slice(1));
    opt.announce = function(to){
		...
		var mesh = opt.mesh = opt.mesh || Zen.Mesh(root), wired = mesh.wire;
    mesh.hear['rtc'] = plan;
