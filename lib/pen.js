...
(function(){
  ...
  if (Gun && !Gun.SEA && SEAmod) { Gun.SEA = SEAmod; }
  var SEA  = (Gun && Gun.SEA) || SEAmod;

  var fs   = (_req && typeof process !== 'undefined' && process.versions && process.versions.node) ? _req('fs')   : null;
  var path = (_req && typeof process !== 'undefined' && process.versions && process.versions.node) ? _req('path') : null;
  ...
  pen.ready = (function() {
    ...
    if (typeof process !== 'undefined' && process.versions && process.versions.node) {
      return Promise.all([import('fs'), import('path')]).then(function(mods) {
        ...
        var dir = (typeof __dirname !== 'undefined') ? __dirname
                : (typeof __filename !== 'undefined') ? pm.dirname(__filename)
                : (function() {
                    var m = (new Error().stack || '').match(/file:\/\/(\/[^:)\s]+\/pen\.js)/);
                    return m ? pm.dirname(m[1]) : pm.dirname(process.argv[1] || '.');
                  }());
    ...
    if (typeof fetch !== 'undefined') {
      ...
      if (typeof document !== 'undefined' && document.currentScript) {
        ...
        try {
          var _m = (new Error().stack || '').match(/(https?:\/\/[^\s)]+\/)pen\.js/);
          if (_m) base = _m[1];
        } catch(_e) {}
      }
      return fetch(base + 'pen.wasm').then(function(r) {
  ...
  function applypolicy(policy, ctx, reject) {
    ...
    if (policy.sign) {
      ...
      SEA.opt.pack(msg.put, function(packed) {
        SEA.verify(packed, raw2['*'] || sec.upub || null, function(data) {
  ...
  function penStage(ctx, next, reject) {
    ...
    var sec = (SEA.check && SEA.check.$sea) ? SEA.check.$sea(ctx.msg, (ctx.at && ctx.at.user) || '', null) : {};
    ...
    pen.ready.then(function() {
      ...
      if (policy.pow) {
        ...
        return SEA.hash(field, null, function(hash) {
  ...
  if (SEA && SEA.check && SEA.check.use) {
