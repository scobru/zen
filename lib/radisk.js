...
(function(){
	...
	function Radisk(opt){
		...
		opt.file = tpath(opt.file, 'radata', __gun && __gun.TESTING);
    ...
    r.tags = {};
		...
		*/
		...
		try{ !Gun.globalThis && __radmigtmp(r) }catch(e){}
	...
	var Gun = (typeof globalThis !== "undefined" && globalThis.Gun)? globalThis.Gun : __gun;
	var Radix = (typeof globalThis !== "undefined" && globalThis.Radix)? globalThis.Radix : __radix;
