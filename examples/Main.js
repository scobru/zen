...
if (!isElectron && "serviceWorker" in navigator) {
  window.addEventListener("load", function () {
    navigator.serviceWorker
      .register("iris/serviceworker.js")
      .catch(function (err) {
        // registration failed :(
...
const APPLICATIONS = [
  ...
  { url: "../stats.html", text: "Zen node stats" },
  {
    url: "../iris/index.html",
    text: "Iris",
    icon: html`<img src="iris/img/icon128.png" width="24" />`,
  },
  ...
  return html`
    <div class="main-view">
      <div class="centered-container public-messages-view">
        ...
        >
        <a class="msg" href="game/space.html"
          ><div class="msg-content">
            <div class="img-container">
              <img src="iris/img/space-game.jpg" />
            </div>
            <b>Space</b>
            <p>Spaceflight game. Open in 2 or more browser windows.</p>
          </div></a
        >
        <a class="msg" href="/iris/index.html"
          ><div class="msg-content">
            <div class="img-container">
              <img src="iris/img/screenshot.png" />
            </div>
            <b>Iris</b>
            <p>
              Decentralized Twitter/Instagram. Provides modular components that
              can be reused in other applications (including this one).
            </p>
          </div></a
        >
...
class MenuView extends Component {
  ...
  render() {
    ...
    return html`
      <div
        class="application-list ${this.state.showMenu ? "menu-visible-xs" : ""}"
      >
        <a href="/profile/${pub}">
...
class Main extends Component {
  ...
  handleRoute(e) {
    ...
    if (activeRoute && activeRoute.length > 1) {
      document.title +=
        " - " + Helpers.capitalize(activeRoute.replace("/", ""));
    }
